...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                dcc.Input(id='TotalBsmtSF', value=1000, type='number', min=0, max=6100, step=1),
    ...
    html.Div('Predicted Price = (- $1,360.5K Baseline) + ($0.7K * Year Built) + ($12.7K * Bathrooms) + (- $7.7K * Bedrooms) + ($0.049K * Total Square Feet) + ($ 25.2K * Single Family Home) + (- $0.044 K * Total Basement Square Feet)'),
    html.Br(),
...
@app.callback(
    ...
    State(component_id='TotalBsmtSF ', component_property='value')

)
def ames_lr_function(clicks, YearBuilt,Bathrooms,BedroomAbvGr,TotalSF,SingleFam,TotalBsmtSF ):
    if clicks==0:
        return "waiting for inputs"
    else:
        y = [-1360501.3809 + 704.4287*YearBuilt + 12738.4775*Bathrooms + -7783.1712*BedroomAbvGr + 49.824*TotalSF+ 25282.091*SingleFam+ -44.0263*TotalBsmtSF]
